...
futures = "0.3"`,
    ...
    },
    {
      ...
      rows: [
        ...
        ['`mcp`', '[MCP toolset](/docs/mcp) — stdio and streamable-HTTP transports.', '`reqwest`, `eventsource-stream`'],
        ...
        ['`auth`', '[Credential flows](/docs/auth): OAuth2, service-account JWTs, API keys.', '`reqwest`, `oauth2`, `jsonwebtoken`, `rand`'],
        ['`openapi`', '[OpenAPI 3.x tool generator](/docs/openapi-tools).', '`reqwest`, `openapiv3`, `serde_yaml`'],
        ...
        ['`a2a`', '[Agent-to-Agent](/docs/a2a) JSON-RPC client + server bridge.', '`reqwest`, `eventsource-stream`, `axum`, `tower`, `tower-http`, `http`'],
